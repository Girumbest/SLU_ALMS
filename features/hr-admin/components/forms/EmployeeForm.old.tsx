...
// use isPending instead of `useFormStatus().pending`
  ...
  const togglePhotoSource = () => {
    ...
    setPhotoPreview(null); // Clear the preview when toggling
  };
  //---------------------------------------
      ...
      <div className="input-group">
        ...
        <div className="col-span-1 md:col-span-2">
          ...
          <button
            ...
            className="ml-4 bg-gray-300 text-gray-700 py-1 px-3 rounded-md text-sm hover:bg-gray-400 transition"
          >
