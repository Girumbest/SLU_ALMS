...
// const DepartmentEmployeeTable: React.FC<EmployeeTableProps> = ({employees, depName}) => {
...
//       <h2 className="text-2xl font-bold text-gray-800 mb-4">{`${depName} Employees List`}</h2>
...
//               {["Photo", "Name", "Username", "Phone", "Job Title",  "Salary", "Hire Date", "Actions"].map((header, index) => (
...
//                   {["username", "phoneNumber", "jobTitle",  "salary", "hireDate"].map((field) => (
